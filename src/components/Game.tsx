...
function Game() {
    const [gameState,setGameState] =useState(initialState.food);

    const onKeyDown = (e: any) => {
      e = e || window.event;
      switch (e.keyCode) {
            case 38:
                setGameState(gameState => ({...gameState, direction: 'UP'}));
                break;
            case 40:
                setGameState(gameState => ({...gameState, direction: 'DOWN'}));
                break;
            case 37:
                setGameState(gameState => ({...gameState, direction: 'LEFT'}));
                break;
            case 39:
                setGameState(gameState => ({...gameState, direction: 'RIGHT'}));
                break;
      }
     }
...
//                 }}>{this.state.play ? "End Game" : "Play Game dasdsa"}</button>
//                 {this.state.play ? 
...
//                     <InfoScore score={this.state.snakeDots.length - 2}/>
//                   </div>
//               :
